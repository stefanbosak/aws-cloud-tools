...
ARG ANSIBLE_CLI_VERSION=v2.20.1

# AWS CLI tools versions
ARG AWS_CLI_VERSION=2.27.12
ARG AWS_SAM_CLI_VERSION=v1.151.0

# Helm version
ARG HELM_CLI_VERSION=v4.0.5

# kubectl version
ARG K9S_CLI_VERSION=v0.50.18

# kops version
ARG KOPS_CLI_VERSION=v1.34.1

# kubectl version
ARG KUBECTL_CLI_VERSION=v1.35.0

# Terraform version
ARG TERRAFORM_CLI_VERSION=1.14.3

# Terragrunt version
ARG TERRAGRUNT_CLI_VERSION=v0.97.2
