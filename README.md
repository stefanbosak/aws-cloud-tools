...
| **AWS CLI** | [`2.36.39`](https://github.com/aws/aws-cli/releases/tag/2.36.39) |
| **AWS SAM CLI** | [`v1.166.1`](https://github.com/aws/aws-sam-cli/releases/tag/v1.166.1) |
...
> 🔄 Last updated: 2026-09-04T02:35:45Z · [Build #263](https://github.com/stefanbosak/aws-cloud-tools/actions/runs/33829798718)
<!-- VERSION_INFO_END -->
...
| [OpenTofu](https://opentofu.org/) | <span style="color: #1a7f37;">Open-source Terraform fork for Infrastructure as Code</span> |
