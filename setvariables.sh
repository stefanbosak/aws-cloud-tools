...
export ANSIBLE_CLI_VERSION=${ANSIBLE_CLI_VERSION:-v2.20.1}

# AWS CLI tools versions
export AWS_CLI_VERSION=${AWS_CLI_VERSION:-2.27.12}
export AWS_SAM_CLI_VERSION=${AWS_SAM_CLI_VERSION:-v1.151.0}

# Helm version
export HELM_CLI_VERSION=${HELM_CLI_VERSION:-v4.0.5}

# k9s version
export K9S_CLI_VERSION=${K9S_CLI_VERSION:-v0.50.18}

# kops version
export KOPS_CLI_VERSION=${KOPS_CLI_VERSION:-v1.34.1}

# kubectl version
export KUBECTL_CLI_VERSION=${KUBECTL_CLI_VERSION:-v1.35.0}

# Terraform version
export TERRAFORM_CLI_VERSION=${TERRAFORM_CLI_VERSION:-1.14.3}

# Terragrunt version
export TERRAGRUNT_CLI_VERSION=${TERRAGRUNT_CLI_VERSION:-v0.97.2}
