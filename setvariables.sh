...
export ANSIBLE_CLI_VERSION=${ANSIBLE_CLI_VERSION:-2.18.2}

# AWS CLI tools versions
export AWS_CLI_VERSION=${AWS_CLI_VERSION:-2.15.12}
export AWS_SAM_CLI_VERSION=${AWS_SAM_CLI_VERSION:-v1.107.0}

# Helm version
export HELM_CLI_VERSION=${HELM_CLI_VERSION:-v3.14.0}

# kops version
export KOPS_CLI_VERSION=${KOPSL_CLI_VERSION:-v1.28.2}

# kubectl version
export KUBECTL_CLI_VERSION=${KUBECTL_CLI_VERSION:-v1.29.1}

# Terraform version
export TERRAFORM_CLI_VERSION=${TERRAFORM_CLI_VERSION:-1.7.0}

# Terragrunt version
export TERRAGRUNT_CLI_VERSION=${TERRAGRUNT_CLI_VERSION:-v0.54.20}
