...
# Helm version
export HELM_CLI_VERSION=${HELM_CLI_VERSION:-v3.13.3}

# kops version
export KOPS_CLI_VERSION=${KOPSL_CLI_VERSION:-v1.28.2}

# kubectl version
export KUBECTL_CLI_VERSION=${KUBECTL_CLI_VERSION:-v1.29.0}

# Terraform version
export TERRAFORM_CLI_VERSION=${TERRAFORM_CLI_VERSION:-1.6.6}

# Terragrunt version
export TERRAGRUNT_CLI_VERSION=${TERRAGRUNT_CLI_VERSION:-v0.54.15}
