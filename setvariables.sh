...
export AWS_CLI_VERSION=${AWS_CLI_VERSION:-2.27.7}
export AWS_SAM_CLI_VERSION=${AWS_SAM_CLI_VERSION:-v1.133.0}
...
# Terragrunt version
export TERRAGRUNT_CLI_VERSION=${TERRAGRUNT_CLI_VERSION:-v0.78.0}
